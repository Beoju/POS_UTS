...
class BarangController extends Controller
{
    ...
    {
        $barang = BarangModel::select('barang_id', 'barang_kode', 'barang_nama', 'harga_beli', 'harga_jual', 'photo', 'kategori_id')->with('kategori');
    ...
    public function update_ajax(Request $request, $id)
    {
        ...
        if ($request->ajax() || $request->wantsJson()) {
            ...
            if ($request->hasFile('photo')) {
                // hapus file lama
                if ($barang->photo && file_exists(public_path('storage/image/' . $barang->photo))) {
                    unlink(public_path('storage/image/' . $barang->photo));
                }
